...
function HeaderAdmin() {
  ...
  <Navbar.Brand href="#" ><img src="logo.png" style={{height:'25%',width:'25%'}}></img></Navbar.Brand>
    ...
    <Navbar.Offcanvas
      ...
      placement="start"
	  style={{width:"200px",align:"center",backgroundColor:"#8AE3FB"}}
    >
      ...
      <Offcanvas.Body>
	  <img src="icon.png" className="App-logo" alt="logo" style={{
...
marginLeft:"20px",
  marginBottom:"30px"
        ...
        <Nav className="justify-content-end flex-grow-1 pe-3" style={{textAlign:"center",fontFamily:"Harmattan",fontSize:"16px",textDecoration:"none solid rgb(0,0,0)"}} >
          ...
          <NavDropdown title="MenuAdmin" id="offcanvasNavbarDropdown">
            <NavDropdown.Item href="/CrudUser">Crud User</NavDropdown.Item>
            <NavDropdown.Item href="/CrudAnnonce">Crud Annonce</NavDropdown.Item>
